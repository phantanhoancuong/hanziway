            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="flex flex-wrap gap-2">
                {entry.var.map((varChar, i) => (
                  <button
                    key={i}
                    className="bg-elevated border-border text-foreground/60 hover:text-foreground hover:border-foreground/30 aspect-square w-1/3 cursor-pointer rounded-lg border text-4xl transition-all outline-none sm:w-1/4"
